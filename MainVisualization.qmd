...
cancer_data_2019 <- cancer_data_2019 %>%
  mutate(cause_group = case_when(
    ...
    cause_name %in% c("Breast cancer", "Cervical cancer", "Uterine cancer", "Prostate cancer", "Ovarian cancer", "Testicular cancer") ~ "Reproductive",
    ...
    cause_name %in% c("Other malignant neoplasms", "Other neoplasms") ~ "Others (Neoplasms)",
...
p <- p +
  labs(
    title = "Global Cancer Deaths by Type and Gender in 2019",
    x = "Type",
    y = "Number of Deaths",
    fill = "Gender",
